...
-- | Ao receber um 'Jogo' e um 'Movimento', esta função devolve um 'Jogo' no qual o 'Movimento' já foi aplicado 
...
-- | Esta função faz praticamente o mesmo que a anterior, contudo é mais poderosa uma vez que é capaz de receber uma lista de 'Movimento'
